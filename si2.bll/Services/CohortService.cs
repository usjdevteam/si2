...
namespace si2.bll.Services
{
    public class CohortService : ServiceBase, ICohortService
    {
        ...
        public async Task AssignUsersToCohortAsync(Guid cohortId, ManageUsersCohortDto manageUsersCohortDto, CancellationToken ct)
        {
            ...
            if (manageUsersCohortDto.AddUsersIds != null)
            {
                foreach (var userId in manageUsersCohortDto.AddUsersIds)
                {
            ...
            if (manageUsersCohortDto.DeleteUsersIds != null)
            {
                foreach (var userId in manageUsersCohortDto.DeleteUsersIds)
                {
